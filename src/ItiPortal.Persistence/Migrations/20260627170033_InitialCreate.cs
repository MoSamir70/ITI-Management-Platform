        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RequestedDatesJson = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CertificateKpiEnabled = table.Column<bool>(type: "bit", nullable: false),
                    FreelanceKpiEnabled = table.Column<bool>(type: "bit", nullable: false),
                    Status = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    RowVersion = table.Column<byte[]>(type: "varbinary(max)", nullable: false)
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Tracks_AspNetUsers_SupervisorId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GradingMode = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false),
                    CertificateKpiEnabled = table.Column<bool>(type: "bit", nullable: false),
                    FreelanceKpiEnabled = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExamLink = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    KpiType = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    Title = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: false),
                    IssuingBody = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    IssueDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ExpiryDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    Platform = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    ClientContact = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: true),
                    ProjectDescription = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: true),
                    AmountEarned = table.Column<decimal>(type: "decimal(10,2)", precision: 10, scale: 2, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_KPIs_AspNetUsers_StudentId",
                        column: x => x.StudentId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_KPIs_Courses_CourseId",
                        column: x => x.CourseId,
                        principalTable: "Courses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_KPIs_Tracks_TrackId",
                        column: x => x.TrackId,
                        principalTable: "Tracks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SessionOrdinal = table.Column<int>(type: "int", nullable: false),
                    IsAbsent = table.Column<bool>(type: "bit", nullable: false),
                    AbsenceRequestId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Attendance_AbsenceRequests_AbsenceRequestId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CourseId = table.Column<int>(type: "int", nullable: false),
                    GroupId = table.Column<int>(type: "int", nullable: false),
                    LabGrade = table.Column<decimal>(type: "decimal(5,2)", precision: 5, scale: 2, nullable: true),
                    ...
                    AbsencePercentage = table.Column<decimal>(type: "decimal(5,2)", precision: 5, scale: 2, nullable: true),
                    IsPublished = table.Column<bool>(type: "bit", nullable: false),
                    PublishedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    PublishedById = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    Notes = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Grades_AspNetUsers_PublishedById",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GroupTAs", x => new { x.GroupId, x.UserId });
                    table.ForeignKey(
                        name: "FK_GroupTAs_AspNetUsers_AssignedById",
                        column: x => x.AssignedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_GroupTAs_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_GroupTAs_Groups_GroupId",
                        column: x => x.GroupId,
                        principalTable: "Groups",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_StudentCourseEnrollments_Groups_GroupId",
                        column: x => x.GroupId,
                        principalTable: "Groups",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CorrectiveExamStudents", x => new { x.ExamId, x.StudentId });
                    table.ForeignKey(
                        name: "FK_CorrectiveExamStudents_AspNetUsers_StudentId",
                        column: x => x.StudentId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CorrectiveExamStudents_Exams_ExamId",
                        column: x => x.ExamId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AbsenceRequests_ReviewedById",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Attendance_AbsenceRequestId",
                table: "Attendance",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Attendance_StudentId_CourseId_SessionDate_SessionType_SessionOrdinal",
                table: "Attendance",
                columns: new[] { "StudentId", "CourseId", "SessionDate", "SessionType", "SessionOrdinal" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CorrectiveExamStudents_StudentId",
                table: "CorrectiveExamStudents",
                column: "StudentId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Groups_TrackId_Name",
                table: "Groups",
                columns: new[] { "TrackId", "Name" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_GroupTAs_AssignedById",
                table: "GroupTAs",
                column: "AssignedById");

            migrationBuilder.CreateIndex(
                name: "IX_GroupTAs_UserId",
                table: "GroupTAs",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_Intakes_BranchId_Number",
                table: "Intakes",
                columns: new[] { "BranchId", "Number" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_KPIs_CourseId",
                table: "KPIs",
                column: "CourseId");

            migrationBuilder.CreateIndex(
                name: "IX_KPIs_StudentId",
                table: "KPIs",
                column: "StudentId");

            migrationBuilder.CreateIndex(
                name: "IX_KPIs_TrackId",
                table: "KPIs",
                column: "TrackId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentCourseEnrollments_GroupId",
                table: "StudentCourseEnrollments",
                column: "GroupId");

            migrationBuilder.CreateIndex(
                name: "IX_Tracks_IntakeId_SupervisorId",
                table: "Tracks",
                columns: new[] { "IntakeId", "SupervisorId" },
                unique: true);
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_AbsenceRequests_AspNetUsers_ReviewedById",
                table: "AbsenceRequests",
                column: "ReviewedById",
                principalTable: "AspNetUsers",
                principalColumn: "Id",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_AbsenceRequests_AspNetUsers_StudentId",
                table: "AbsenceRequests",
                column: "StudentId",
                principalTable: "AspNetUsers",
                principalColumn: "Id",
